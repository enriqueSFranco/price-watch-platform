'use client';
import { LoginForm } from '@/sections/auth/components/LoginForm';
	...
	return (
        ...
        "
			>
				...
				<p className="text-center text-neutral-500 dark:text-neutral-400 mb-8">Accede a tu cuenta para continuar</p>
